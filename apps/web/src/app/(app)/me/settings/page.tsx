...
import { ArrowLeft, Palette, Ruler, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="max-w-md mx-auto px-4 pt-5 pb-24 space-y-5">
      ...
      <div className="bg-bg-elevated rounded-2xl overflow-hidden">
        ...
        <Link href="/me/settings/units" className="flex items-center gap-3 px-4 py-3.5 hover:bg-bg-raised transition-colors">
